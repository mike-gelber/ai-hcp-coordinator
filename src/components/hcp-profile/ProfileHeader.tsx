      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex items-start gap-4">
            {/* Avatar */}
            <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-brand-100 text-xl font-bold text-brand-700 dark:bg-brand-900 dark:text-brand-300">
              {initials}
            </div>
            ...
            <div>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <span className="rounded-full bg-brand-100 px-3 py-0.5 text-xs font-medium text-brand-700 dark:bg-brand-900 dark:text-brand-300">
                  {profile.primarySpecialty}
                </span>
