...
export default function HcpProfilePage() {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-surface-base">
        <div className="text-center">
          ...
          <a
            href="/dashboard"
            className="mt-4 inline-block rounded-lg bg-brand-400 px-4 py-2 text-sm font-medium text-surface-base hover:bg-brand-300 transition-colors"
          >
            Back to Dashboard
          </a>
        </div>
  ...
  return (
    <div className="min-h-screen bg-surface-base">
      ...
      {/* Tabs */}
      <div className="sticky top-0 z-30 border-b border-surface-border bg-surface-card">
        <div className="px-6">
